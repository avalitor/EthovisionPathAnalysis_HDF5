...
exp = plib.TrialData()
exp.Load('2022-10-11', '3', 'Probe') #load the experiment trial
...
exps[0].Load('2022-10-11', '2', 'Probe 2') #load the experiment trial for rotated 90 coords
exps[1].Load('2022-10-11', '3', 'Probe 2') #load the experiment trial
points_random = [exps[0].target, exps[0].target_reverse]
dist_rand = calc.calc_dist_bw_points(exps[1].r_center, points_random[0], points_random[1]) #calculate distance between two points
